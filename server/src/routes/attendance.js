...
const OFFICE_LAT = Number.isFinite(parseFloat(process.env.OFFICE_LAT)) ? parseFloat(process.env.OFFICE_LAT) : 17.438989;
const OFFICE_LONG = Number.isFinite(parseFloat(process.env.OFFICE_LONG)) ? parseFloat(process.env.OFFICE_LONG) : 78.394794;
const OFFICE_RADIUS = Number.isFinite(parseFloat(process.env.OFFICE_RADIUS)) ? parseFloat(process.env.OFFICE_RADIUS) : 30;
