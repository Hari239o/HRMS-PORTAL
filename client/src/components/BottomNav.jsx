...
export default function BottomNav() {
 ...
 {showProfile && (
 <>
 <div className="fixed inset-0 bg-slate-900/20 z-40 md:hidden" onClick={() => setShowProfile(false)} />
 <div className="fixed bottom-[72px] left-4 right-4 bg-white rounded-3xl p-5 shadow-2xl border border-slate-100 z-50 md:hidden ">
 ...
 >
 <div className={`p-1.5 rounded-full transition-colors ${isActive ? 'bg-[#ff5a1f]/10' : ''}`}>
 {item.name === 'Profile' ? (
