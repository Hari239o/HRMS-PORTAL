...
export default function InstallPrompt() {
 ...
 return (
 <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/95 border-t border-slate-200 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] z-[9999] flex flex-col md:flex-row items-center justify-between gap-4 rounded-t-3xl">
 ...
 className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-black rounded-xl shadow-md shadow-blue-200 active:scale-95 whitespace-nowrap"
 >
 Install App
 </button>
 )}
