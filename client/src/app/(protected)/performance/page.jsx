...
export default function Performance() {
 ...
 <Trophy className="absolute inset-0 m-auto text-blue-600 " size={24} />
 </div>
 </div>
 );
 }
 ...
 <div className="relative overflow-hidden rounded-3xl bg-slate-900 p-10 shadow-2xl border border-slate-800 ">
 ...
 <div className="group relative bg-white/80 rounded-3xl p-6 shadow-xl border border-white hover:border-blue-200 hover:shadow-2xl overflow-hidden ">
 <div className="absolute top-0 right-0 w-32 h-32 bg-blue-100 rounded-bl-full -mr-10 -mt-10 transition-transform group-"></div>
 ...
 <div 
 className="h-full rounded-full bg-gradient-to-r from-blue-500 to-purple-500 ease-out relative overflow-hidden" 
 ...
 {progressPercent >= 100 && <span className="text-emerald-500 ">🔥 Target Hit</span>}
 </p>
 </div>
 </div>

 {/* Widget 2: Total Intakes */}
 <div className="group relative bg-white/80 rounded-3xl p-6 shadow-xl border border-white hover:border-sky-200 hover:shadow-2xl overflow-hidden ">
 <div className="absolute top-0 right-0 w-32 h-32 bg-sky-100 rounded-bl-full -mr-10 -mt-10 transition-transform group-"></div>
 <div className="relative z-10 flex items-start justify-between gap-4">
 <div>
 ...
 <div className="group relative bg-white/80 rounded-3xl p-6 shadow-xl border border-white hover:border-emerald-200 hover:shadow-2xl overflow-hidden ">
 <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-100 rounded-bl-full -mr-10 -mt-10 transition-transform group-"></div>
 <div className="relative z-10 flex items-start justify-between gap-4">
 <div>
 ...
 <div className={`group relative bg-white/80 rounded-3xl p-6 shadow-xl border border-white overflow-hidden ${progressTone === 'emerald' ? 'hover:border-emerald-200 hover:shadow-emerald-500/20' : 'hover:border-amber-200 hover:shadow-amber-500/20'}`}>
 <div className={`absolute top-0 right-0 w-32 h-32 rounded-bl-full -mr-10 -mt-10 transition-transform group- ${progressTone === 'emerald' ? 'bg-emerald-100' : 'bg-amber-100'}`}></div>
 <div className="relative z-10 flex items-start justify-between gap-4">
 <div>
 ...
 {/* TRENDS CHART */}
 <div className="bg-white/90 rounded-3xl shadow-xl border border-white p-8 ">
 ...
 type="text" 
 required 
 className="w-full bg-white border-2 border-slate-100 rounded-xl px-4 py-3 text-sm font-semibold text-slate-800 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none shadow-sm"
 ...
 <span className="absolute inset-0 bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500 rounded-xl opacity-70 group-hover:opacity-100 blur-sm transition-opacity "></span>
 <span className="absolute inset-0 bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500 rounded-xl "></span>
 <div className="relative flex items-center justify-center gap-2 bg-blue-600 px-4 py-3.5 rounded-xl group-hover:bg-opacity-0">
 ...
 className="flex items-center gap-2 px-5 py-2.5 bg-white border-2 border-slate-200 rounded-xl text-sm font-bold text-slate-700 hover:bg-slate-50 hover:border-slate-300 hover:shadow-md group"
 >
 <Download size={16} className="text-blue-500 group- transition-transform" /> 
 Export CSV
 </button>
 </div>
 ...
 <tr key={sub.id} className="hover:bg-blue-50/30 border-b border-slate-50 last:border-0 group">
 ...
 <button onClick={() => handleUpdateStatus(sub.id, 'callStatus', 'Answered')} className={`px-3 py-1 text-[10px] font-black uppercase tracking-wider rounded-md ${sub.callStatus === 'Answered' ? 'bg-emerald-500 text-white shadow-md shadow-emerald-500/20' : 'text-slate-500 hover:text-slate-800 hover:bg-white'}`}>Call Done</button>
 <button onClick={() => handleUpdateStatus(sub.id, 'callStatus', 'Dropped')} className={`px-3 py-1 text-[10px] font-black uppercase tracking-wider rounded-md ${sub.callStatus === 'Dropped' ? 'bg-rose-500 text-white shadow-md shadow-rose-500/20' : 'text-slate-500 hover:text-slate-800 hover:bg-white'}`}>No Ans</button>
 </div>
 <div className="flex bg-slate-100 p-1 rounded-lg border border-slate-200 shadow-inner w-max">
 <button onClick={() => handleUpdateStatus(sub.id, 'paymentStatus', 'Paid')} className={`px-3 py-1 text-[10px] font-black uppercase tracking-wider rounded-md ${sub.paymentStatus === 'Paid' ? 'bg-blue-500 text-white shadow-md shadow-blue-500/20' : 'text-slate-500 hover:text-slate-800 hover:bg-white'}`}>Fee Paid</button>
 <button onClick={() => handleUpdateStatus(sub.id, 'paymentStatus', 'Dropped')} className={`px-3 py-1 text-[10px] font-black uppercase tracking-wider rounded-md ${sub.paymentStatus === 'Dropped' ? 'bg-rose-500 text-white shadow-md shadow-rose-500/20' : 'text-slate-500 hover:text-slate-800 hover:bg-white'}`}>Dropped</button>
 </div>
 </div>
 </td>
 ...
 className="w-8 h-8 rounded-full bg-white border border-slate-200 text-rose-400 flex items-center justify-center hover:bg-rose-500 hover:text-white hover:border-rose-500 hover:shadow-lg hover:shadow-rose-500/30 opacity-0 group-hover:opacity-100"
 title="Delete Record"
 >
 <Trash2 size={14} />
 </button>
 ...
 <select 
 required 
 className="w-full bg-white border-2 border-slate-100 rounded-xl px-4 py-3 text-sm font-semibold text-slate-800 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none shadow-sm appearance-none"
 ...
 type="number" 
 required 
 className="w-full bg-white border-2 border-slate-100 rounded-xl px-4 py-3 text-sm font-black text-slate-800 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none shadow-sm"
 ...
 type="month" 
 required 
 className="w-full bg-white border-2 border-slate-100 rounded-xl px-4 py-3 text-sm font-semibold text-slate-800 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none shadow-sm"
 value={adminForm.month}
 onChange={(e) => setAdminForm({...adminForm, month: e.target.value})}
 />
 </div>
 <button type="submit" className="w-full mt-4 relative overflow-hidden group rounded-xl p-[2px]">
 <span className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-xl opacity-70 group-hover:opacity-100 blur-sm transition-opacity "></span>
 <span className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-xl"></span>
 <div className="relative flex items-center justify-center gap-2 bg-emerald-600 px-4 py-3.5 rounded-xl group-hover:bg-opacity-0">
 ...
 <div className="lg:col-span-2 relative rounded-3xl shadow-2xl border border-white/60 overflow-hidden bg-gradient-to-br from-blue-900 via-slate-900 to-blue-950 ">
 ...
 className="w-full pl-11 pr-4 py-3 text-sm border-2 border-blue-500/30 rounded-xl outline-none focus:border-blue-400 transition-colors bg-white/5 font-semibold text-white placeholder:text-blue-300/50"
 ...
 <tr key={emp.id} className="hover:bg-white/5 border-b border-blue-500/10 last:border-0 group">
 <td className="px-6 py-5">
 ...
 <button onClick={() => grantBadge(emp.id, 'week')} className="px-3 py-1.5 bg-blue-500/20 text-blue-300 hover:bg-blue-500 hover:text-white border border-blue-500/30 rounded-lg text-[10px] font-black uppercase tracking-widest shadow-sm ">Week</button>
 <button onClick={() => grantBadge(emp.id, 'month')} className="px-3 py-1.5 bg-sky-500/20 text-sky-300 hover:bg-sky-500 hover:text-white border border-sky-500/30 rounded-lg text-[10px] font-black uppercase tracking-widest shadow-sm ">Month</button>
 <button onClick={() => grantBadge(emp.id, 'none')} className="px-3 py-1.5 bg-white/5 text-slate-400 hover:bg-rose-500 hover:text-white border border-white/10 rounded-lg text-[10px] font-black uppercase tracking-widest shadow-sm ">Clear</button>
 </div>
 </td>
 <td className="px-6 py-5 text-right">
 {emp.deviceId ? (
 ...
 className="text-[10px] text-white bg-rose-500 hover:bg-rose-600 px-3 py-1.5 rounded-lg font-black uppercase tracking-widest flex items-center gap-1.5 shadow-lg shadow-rose-500/30 border border-rose-400"
 >
 ...
 <select 
 className="w-full bg-white border-2 border-slate-200 rounded-xl px-4 py-3 text-sm font-semibold text-slate-700 outline-none focus:border-blue-500 shadow-sm appearance-none cursor-pointer"
 ...
 className="flex w-full md:w-auto items-center justify-center gap-2 px-6 py-3 bg-slate-900 text-white rounded-xl text-sm font-bold hover:bg-slate-800 shadow-lg shadow-slate-900/20 "
 >
 ...
 <tr key={sub.id} className="hover:bg-blue-50/30 group">
 <td className="px-6 py-5">
 <p className="font-black text-sm text-slate-800 mb-0.5">{sub.studentName}</p>
 ...
 <div className="flex flex-col gap-2 items-center">
 <div className="flex bg-slate-100 p-1 rounded-lg border border-slate-200 shadow-inner w-max">
 <button onClick={() => handleUpdateStatus(sub.id, 'callStatus', 'Answered', true)} className={`px-3 py-1 text-[10px] font-black uppercase tracking-wider rounded-md ${sub.callStatus === 'Answered' ? 'bg-emerald-500 text-white shadow-md shadow-emerald-500/20' : 'text-slate-500 hover:text-slate-800 hover:bg-white'}`}>Answered</button>
 <button onClick={() => handleUpdateStatus(sub.id, 'callStatus', 'Dropped', true)} className={`px-3 py-1 text-[10px] font-black uppercase tracking-wider rounded-md ${sub.callStatus === 'Dropped' ? 'bg-rose-500 text-white shadow-md shadow-rose-500/20' : 'text-slate-500 hover:text-slate-800 hover:bg-white'}`}>Missed</button>
 </div>
 <div className="flex bg-slate-100 p-1 rounded-lg border border-slate-200 shadow-inner w-max">
 <button onClick={() => handleUpdateStatus(sub.id, 'paymentStatus', 'Paid', true)} className={`px-3 py-1 text-[10px] font-black uppercase tracking-wider rounded-md ${sub.paymentStatus === 'Paid' ? 'bg-blue-500 text-white shadow-md shadow-blue-500/20' : 'text-slate-500 hover:text-slate-800 hover:bg-white'}`}>Collected</button>
 <button onClick={() => handleUpdateStatus(sub.id, 'paymentStatus', 'Dropped', true)} className={`px-3 py-1 text-[10px] font-black uppercase tracking-wider rounded-md ${sub.paymentStatus === 'Dropped' ? 'bg-rose-500 text-white shadow-md shadow-rose-500/20' : 'text-slate-500 hover:text-slate-800 hover:bg-white'}`}>Lost</button>
 </div>
 </div>
 </td>
 <td className="px-6 py-5 text-right">
