...
export default function HRPolicies() {
 ...
 className="flex items-center gap-2 px-6 py-2.5 bg-white border border-slate-200 hover:border-[#ff5a1f]/50 hover:bg-[#ff5a1f]/5 text-slate-700 hover:text-[#ff5a1f] rounded-xl font-bold text-sm shadow-sm "
 >
 ...
 <div key={index} className="bg-white rounded-3xl p-6 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] flex flex-col group">
 <div className="flex items-center gap-4 mb-5">
 <div className={`w-12 h-12 rounded-2xl flex items-center justify-center border shadow-inner transition-transform group- ${getColorClasses(policy.color)}`}>
 <policy.icon size={24} />
 </div>
 ...
 <button className="px-6 py-2.5 bg-[#ff5a1f] hover:bg-[#e04812] text-white rounded-xl font-bold shadow-lg shadow-[#ff5a1f]/30 whitespace-nowrap">
 Contact HR
 </button>
 </div>
 </div>
