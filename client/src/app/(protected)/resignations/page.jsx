...
const Resignations = () => {
 ...
 try {
 const { data } = await api.get(`${process.env.NEXT_PUBLIC_API_URL || ``}/api/resignations`);
 ...
 try {
 await api.post(`${process.env.NEXT_PUBLIC_API_URL || ``}/api/resignations`, formData);
 ...
 <button onClick={() => fetchResignations()} className="px-5 py-3 rounded-xl bg-white/5 hover:bg-white/10 text-white font-bold text-sm border border-white/10 flex items-center gap-2">
 <Activity size={16} /> Refresh
 </button>
 {user.role !== 'admin' && (
 <button 
 onClick={() => setShowResignationForm(true)} 
 className="px-6 py-3 rounded-xl bg-blue-500 hover:bg-blue-600 text-white font-bold text-sm shadow-lg shadow-blue-500/25 flex items-center gap-2"
 >
 ...
 className="px-4 py-2 bg-slate-100 hover:bg-blue-50 text-slate-600 hover:text-blue-600 rounded-lg text-xs font-bold border border-slate-200 hover:border-blue-200"
 >
 Manage
 </button>
 ) : (
 ...
 className="px-3 py-1.5 bg-amber-50 hover:bg-amber-100 text-amber-600 rounded-lg text-xs font-bold border border-amber-200"
 >
 Withdraw
 </button>
 )}
 ...
 className="px-3 py-1.5 bg-rose-50 hover:bg-rose-100 text-rose-600 rounded-lg text-xs font-bold border border-rose-200"
 >
 Delete
 </button>
 )}
 ...
 <div className="bg-white rounded-[24px] w-full max-w-3xl overflow-hidden shadow-2xl border border-slate-200 ">
 ...
 className="w-full p-4 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 font-medium"
 >
 ...
 className="w-full p-4 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 "
 />
 </div>
 ...
 className="w-full p-4 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none flex-1"
 ></textarea>
 </div>
 </div>
 </div>
 ...
 className="flex-1 px-6 py-4 rounded-xl text-slate-600 font-bold bg-white border border-slate-200 hover:bg-slate-50 "
 >
 Cancel
 </button>
 <button 
 type="submit"
 className="flex-1 px-6 py-4 rounded-xl text-white font-bold bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-200 "
 >
 Submit Request
 </button>
 </div>
 ...
 <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 ">
 <div className="bg-white rounded-[24px] w-full max-w-4xl overflow-hidden shadow-2xl border border-slate-200 ">
 ...
 className="w-full p-4 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none h-24"
 ></textarea>
 </div>
 </div>
 ...
 <button 
 type="submit"
 className="flex-1 px-6 py-4 rounded-xl text-white font-bold bg-slate-900 hover:bg-slate-800 shadow-lg shadow-slate-200 "
 >
 Save & Process
 </button>
 </div>
