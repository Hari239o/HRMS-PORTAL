...
export default function Attendance() {
 ...
 className={`relative w-72 h-72 rounded-full overflow-hidden border-8 border-white bg-white shadow-[0_20px_60px_-15px_rgba(59,130,246,0.15)] flex flex-col items-center justify-center cursor-pointer hover:shadow-[0_20px_60px_-10px_rgba(59,130,246,0.25)] active:scale-95 ${scanning ? 'opacity-70 pointer-events-none scale-95' : ''}`}
 >
 ...
 <div className={`relative w-72 h-72 rounded-full overflow-hidden border-8 border-white bg-slate-50 shadow-[0_20px_60px_-15px_rgba(59,130,246,0.2)] flex flex-col items-center justify-center ${todayRecord.checkOut ? 'opacity-80 grayscale scale-95' : 'scale-100'}`}>
 ...
 <div className={`p-4 rounded-full mb-2 transition-colors ${fillPercentage > 40 ? 'bg-white/20 text-white shadow-sm' : 'bg-blue-50 text-blue-500'}`}>
 <Clock size={42} strokeWidth={1.5} />
 </div>
 
 <span className={`text-4xl font-black tabular-nums tracking-tighter drop-shadow-sm transition-colors ${fillPercentage > 50 ? 'text-white' : 'text-slate-800'}`}>
 {getElapsedTimeString()}
 </span>
 
 <div className={`flex flex-col items-center mt-2 transition-colors ${fillPercentage > 60 ? 'text-white' : 'text-slate-500'}`}>
 ...
 disabled={scanning}
 className={`w-64 py-4 rounded-2xl font-black tracking-widest uppercase shadow-xl shadow-blue-500/20 bg-gradient-to-r from-blue-500 to-blue-400 text-white hover:shadow-2xl hover:shadow-blue-500/30 active:scale-95 flex items-center justify-center gap-3 ${scanning ? 'opacity-70 pointer-events-none scale-95' : ''}`}
 >
 <Fingerprint size={22} />
 Secure Punch Out
 </button>
 ...
 <div className="group relative bg-white rounded-3xl p-6 border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] overflow-hidden">
 ...
 <div className="w-12 h-12 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center mb-4 group- transition-transform ">
 <CheckCircle size={24} />
 </div>
 ...
 <input type="date" value={filterDay} onChange={(e) => { setFilterDay(e.target.value); setFilterMonth(''); }} className="w-full px-4 py-2 bg-white border border-slate-200 rounded-xl text-sm font-medium text-slate-700 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 shadow-sm" />
 </div>
 <div className="w-full">
 ...
 <input type="month" value={filterMonth} onChange={(e) => { setFilterMonth(e.target.value); setFilterDay(''); }} className="w-full px-4 py-2 bg-white border border-slate-200 rounded-xl text-sm font-medium text-slate-700 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 shadow-sm" />
 </div>
 <div className="w-full">
 ...
 <select value={filterEmployee} onChange={(e) => setFilterEmployee(e.target.value)} className="w-full px-4 py-2 bg-white border border-slate-200 rounded-xl text-sm font-medium text-slate-700 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 shadow-sm">
 ...
 <Clock size={16} className="text-blue-500 " /> Real-time Sync
 </div>
 </div>
