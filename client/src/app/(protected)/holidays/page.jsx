...
export default function Holidays() {
 ...
 {nextHoliday ? (
 <div className="rounded-2xl border border-blue-100 bg-gradient-to-r from-blue-50 via-white to-fuchsia-50 p-6 sm:p-8 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden group">
 ...
 className="bg-white/80 hover:bg-blue-600 hover:text-white text-blue-600 border border-blue-100 px-4 py-3 rounded-xl font-bold text-sm shadow-sm flex items-center gap-2"
 >
 <Heart size={16} /> Broadcast Wishes
 </button>
 <div className="bg-white/80 rounded-xl px-6 py-3 border border-blue-100 shadow-sm text-center min-w-[140px]">
 ...
 type="text" 
 required 
 className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3.5 text-sm font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 shadow-sm"
 value={formData.name}
 ...
 <select 
 className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3.5 text-sm font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 shadow-sm appearance-none"
 value={formData.type}
 ...
 className="flex-1 rounded-xl border border-slate-200 bg-white px-5 py-3.5 text-sm font-bold text-slate-700 hover:bg-slate-50 hover:border-slate-300 shadow-sm"
 >
 Cancel
 </button>
 <button 
 ...
 className="flex-[2] rounded-xl bg-blue-600 px-5 py-3.5 text-sm font-bold text-white hover:bg-blue-700 shadow-lg shadow-blue-600/20 disabled:opacity-50 flex items-center justify-center gap-2"
 >
 {isSubmitting ? (
