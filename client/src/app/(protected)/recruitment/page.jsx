...
export default function RecruitmentPage() {
 ...
 className="px-6 py-3 bg-blue-600 text-white rounded-xl font-bold text-sm hover:bg-blue-700 flex items-center gap-2 shadow-sm"
 >
 ...
 <button type="submit" className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-md ">
 Post Job
 </button>
 </div>
 </form>
