...
const Leaves = () => {
 ...
 Requests <br className="hidden md:block" /><span className="text-[#ff5a1f]">Center</span>
 </h2>
 <p className="text-slate-500 font-medium text-[10px] md:text-sm mt-2">Enterprise portal for time-off and grievance management.</p>
 </div>
 ...
 className={`flex-1 sm:flex-none px-6 py-2 rounded-lg text-sm font-bold flex items-center justify-center gap-2 ${
 activeTab === 'leaves' 
 ...
 <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm flex items-center gap-4 hover:border-rose-200 transition-colors">
 ...
 <button className="w-full sm:w-auto bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 hover:border-blue-200 px-5 py-2.5 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 shadow-sm ">
 ...
 className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white text-sm font-medium text-slate-800 placeholder:text-slate-400"
 />
 </div>
 ...
 className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-semibold flex items-center gap-2 shadow-sm shrink-0"
 >
 ...
 className="bg-rose-600 hover:bg-rose-700 text-white px-5 py-2.5 rounded-lg text-sm font-semibold flex items-center gap-2 shadow-sm shrink-0"
 >
 ...
 <div key={leave.id} className="bg-white border border-slate-100 rounded-2xl p-0 overflow-hidden hover:shadow-lg group flex flex-col shadow-sm">
 <div className="border-b border-slate-50 bg-slate-50/50 px-6 py-4 flex flex-wrap justify-between items-center gap-4">
 <div className="flex items-center gap-3">
 ...
 <div>
 <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">Employee ID</span>
 <span className="text-sm font-bold text-slate-700">{leave.employee?.empId || leave.employeeId?.slice(-5).toUpperCase() || 'UNKN'}</span>
 </div>
 </div>
 
 <div className="flex items-center gap-2">
 <span className={`px-3 py-1.5 rounded-lg text-[11px] font-bold uppercase tracking-wide flex items-center gap-2 ${
 ...
 <span className="px-3 py-1.5 rounded-lg text-[11px] font-bold uppercase tracking-wide bg-slate-100 text-slate-600 border border-slate-200">
 {leave.type}
 </span>
 </div>
 </div>
 ...
 <div className="flex items-center gap-6 mb-6 border-b border-slate-100 pb-5">
 <div>
 <span className="text-[10px] font-bold text-blue-500 uppercase tracking-widest block mb-1">From Date</span>
 ...
 <div>
 <span className="text-[10px] font-bold text-blue-500 uppercase tracking-widest block mb-1">To Date</span>
 ...
 {leave.documentUrl && (
 <a href={leave.documentUrl} target="_blank" rel="noopener noreferrer" className="mt-4 inline-flex items-center gap-2 text-xs font-bold text-blue-600 hover:text-blue-800 bg-blue-50 px-3 py-1.5 rounded-lg border border-blue-100 transition-colors w-max">
 ...
 <div className="w-full md:w-64 shrink-0 flex flex-col gap-4 border-l-0 md:border-l border-slate-100 md:pl-8">
 <div>
 ...
 className="w-full py-2.5 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 font-semibold text-xs uppercase tracking-wide transition-colors flex items-center justify-center gap-2 shadow-sm hover:shadow-md "
 >
 <CheckCircle2 size={16} /> Approve Leave
 </button>
 <button 
 onClick={() => handleUpdateLeaveStatus(leave.id, 'Rejected')}
 className="w-full py-2.5 bg-white text-slate-600 border border-slate-200 rounded-xl hover:bg-slate-50 hover:text-rose-600 hover:border-rose-200 font-semibold text-xs uppercase tracking-wide transition-colors flex items-center justify-center gap-2"
 >
 ...
 <div className="bg-white border border-slate-100 rounded-3xl text-center py-20 flex flex-col items-center justify-center shadow-sm">
 ...
 <div key={problem.id} className="bg-white border border-slate-100 rounded-2xl p-0 overflow-hidden hover:shadow-lg group flex flex-col shadow-sm">
 <div className="border-b border-slate-50 bg-slate-50/50 px-6 py-4 flex flex-wrap justify-between items-center gap-4">
 <div className="flex items-center gap-3">
 <div className={`p-2 rounded-xl ${
 ...
 <div className="flex items-center gap-2">
 <span className={`px-3 py-1.5 rounded-lg text-[11px] font-bold uppercase tracking-wide flex items-center gap-2 ${
 problem.status === 'Resolved' ? 'bg-blue-50 text-blue-700 border border-blue-100' :
 ...
 <span className="px-3 py-1.5 rounded-lg text-[11px] font-bold uppercase tracking-wide bg-slate-800 text-white shadow-sm">
 {problem.category}
 </span>
 {problem.priority && (
 <span className={`px-3 py-1.5 rounded-lg text-[11px] font-bold uppercase tracking-wide border ${getPriorityColor(problem.priority)}`}>
 {problem.priority}
 </span>
 )}
 </div>
 ...
 <div className="text-sm text-slate-600 bg-slate-50/50 rounded-xl p-4 border border-slate-100 whitespace-pre-wrap leading-relaxed font-medium">
 {problem.description}
 </div>
 {problem.documentUrl && (
 ...
 className="w-full py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 font-semibold text-xs uppercase tracking-wide transition-colors flex items-center justify-center gap-2 shadow-sm hover:shadow-md "
 >
 ...
 <div className="bg-white w-full max-w-lg max-h-[90vh] flex flex-col rounded-3xl shadow-2xl overflow-hidden ">
 ...
 <button onClick={() => setShowLeaveForm(false)} className="text-slate-400 hover:text-slate-700 hover:bg-slate-100 p-2 rounded-xl ">
 <XCircle size={24} />
 </button>
 </div>
 ...
 className="w-full border border-slate-200 rounded-xl p-3 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm font-semibold text-slate-800 bg-white shadow-sm"
 >
 ...
 className="w-full border border-slate-200 rounded-xl p-3 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm font-semibold text-slate-800 bg-white shadow-sm resize-none"
 ></textarea>
 </div>
 <div>
 ...
 className="w-full border border-slate-200 rounded-xl p-2 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm font-semibold text-slate-800 bg-white shadow-sm"
 accept="image/*,application/pdf"
 />
 </div>
 <div className="flex gap-3 pt-4 border-t border-slate-100">
 <button type="button" onClick={() => setShowLeaveForm(false)} className="flex-1 px-4 py-3 bg-white border border-slate-200 text-slate-700 text-sm font-bold rounded-xl hover:bg-slate-50 transition-colors">Cancel</button>
 <button type="submit" className="flex-1 px-4 py-3 bg-blue-600 text-white text-sm font-bold rounded-xl hover:bg-blue-700 shadow-sm hover:shadow-md ">Submit Request</button>
 </div>
 </form>
 </div>
 </div>
 ...
 <button onClick={() => setShowProblemForm(false)} className="text-slate-400 hover:text-slate-700 hover:bg-slate-100 p-2 rounded-xl ">
 <XCircle size={24} />
 </button>
 </div>
 ...
 className="w-full border border-slate-200 rounded-xl p-3 focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500 text-sm font-semibold text-slate-800 bg-white shadow-sm"
 >
 ...
 className="w-full border border-slate-200 rounded-xl p-3 focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500 text-sm font-semibold text-slate-800 bg-white shadow-sm resize-none"
 ></textarea>
 </div>
 <div>
 <label className="block text-xs font-bold text-slate-600 uppercase tracking-wide mb-2">Attach Document (Optional)</label>
 ...
 className="w-full border border-slate-200 rounded-xl p-2 focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500 text-sm font-semibold text-slate-800 bg-white shadow-sm"
 accept="image/*,application/pdf"
 />
 </div>
 <div className="flex gap-3 pt-4 border-t border-slate-100">
 <button type="button" onClick={() => setShowProblemForm(false)} className="flex-1 px-4 py-3 bg-white border border-slate-200 text-slate-700 text-sm font-bold rounded-xl hover:bg-slate-50 transition-colors">Cancel</button>
 <button type="submit" className="flex-1 px-4 py-3 bg-rose-600 text-white text-sm font-bold rounded-xl hover:bg-rose-700 shadow-sm hover:shadow-md ">Submit Ticket</button>
 </div>
 </form>
 </div>
 </div>
