...
export default function Dashboard() {
 ...
 <div 
 onClick={onClick}
 className={`group relative rounded-3xl bg-white border border-slate-200 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] overflow-hidden ${onClick ? 'cursor-pointer hover:ring-2 hover:ring-blue-400' : ''}`}
 >
 ...
 <div className={`w-12 h-12 rounded-2xl flex items-center justify-center ${bgColor} ${textColor} group- transition-transform `}>
 <Icon size={24} />
 </div>
 ...
 return (
 <div className={`flex items-center justify-between p-4 rounded-2xl group cursor-default w-64 ${highlight ? 'bg-indigo-50/60 border-indigo-200 shadow-lg ring-1 ring-indigo-100' : 'bg-white/60 border-white/50 shadow-sm hover:shadow-md hover:border-indigo-200'} border`}>
 ...
 <a href={`mailto:${profile.email}`} className="w-8 h-8 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 hover:bg-blue-50 hover:text-blue-600 border border-slate-100" title={`Email ${profile.name}`}>
 <Mail size={14} />
 </a>
 </div>
 );
 ...
 <Link href={link} className="bg-white rounded-2xl p-4 flex flex-col items-center justify-center gap-3 shadow-[0_2px_10px_rgb(0,0,0,0.02)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-slate-100 group">
 <div className={`w-12 h-12 rounded-xl flex items-center justify-center group- ${colorMap[color] || colorMap.blue}`}>
 ...
 return (
 <div className="flex flex-col gap-5 md:gap-6 pb-12 w-full max-w-lg mx-auto md:max-w-none ">
 ...
 className="w-full pl-12 pr-4 py-3.5 bg-white border border-slate-200/80 rounded-full shadow-[0_2px_10px_rgba(0,0,0,0.02)] text-sm font-medium text-slate-700 outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-slate-400 hover:border-slate-300"
 />
 ...
 {/* Background Glow */}
 <div className="absolute top-0 right-0 -mr-20 -mt-20 w-64 h-64 rounded-full bg-yellow-500/10 blur-3xl group-hover:bg-yellow-400/20 "></div>
 ...
 <div key={star.id} className="bg-white/5 border border-white/10 rounded-2xl p-4 flex items-center gap-4 hover:bg-white/10 hover:shadow-xl hover:shadow-yellow-500/10 group/card">
 <div className="w-14 h-14 rounded-full bg-slate-800 flex items-center justify-center shadow-lg ring-2 ring-yellow-400/50 group-hover/card:ring-yellow-400 overflow-hidden shrink-0 text-yellow-500 font-black text-xl">
 {star.avatar ? (
 <img 
 src={star.avatar} 
 alt={star.name} 
 ...
 <Link href="/attendance" className="w-full bg-gradient-to-r from-orange-400 to-orange-500 rounded-2xl p-5 flex items-center justify-between shadow-xl shadow-orange-500/20 hover:shadow-2xl hover:shadow-orange-500/30 active:scale-[0.98] group">
 <div className="flex items-center gap-3">
 ...
 <div className="rounded-3xl border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white/60 overflow-hidden mb-6 relative">
 ...
 <button type="submit" className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-sm flex-shrink-0">
 Declare
 </button>
 </form>
 </div>
 ...
 {starPerformers.map(star => (
 <div key={star.id} className="bg-gradient-to-r from-slate-900 to-slate-800 border border-slate-700/50 rounded-xl p-3 flex items-center justify-between group hover:border-yellow-500/50 hover:shadow-lg hover:shadow-yellow-500/10">
 <div className="flex items-center gap-3">
 ...
 className="px-3 py-1.5 flex items-center gap-1.5 text-[11px] font-bold bg-white hover:bg-rose-50 text-slate-400 hover:text-rose-600 border border-slate-200 hover:border-rose-200 rounded-lg opacity-0 group-hover:opacity-100" 
 title="Revoke Badge"
 >
 ...
 <div className="lg:col-span-2 card border border-white/50 shadow-xl shadow-slate-100/30 bg-white/60 ">
 ...
 <div className="card bg-white/60 border border-white/50 shadow-[0_4px_20px_rgb(0,0,0,0.03)]">
 ...
 <div className="card border border-white/50 bg-white/60 shadow-[0_4px_20px_rgb(0,0,0,0.03)]">
 <h3 className="font-bold text-sm text-slate-800 mb-4 flex justify-between items-center">
 Quick Actions
 </h3>
 <div className="space-y-2">
 <Link href="/employees" className="flex items-center justify-between p-3 rounded-xl bg-slate-50 hover:bg-slate-100 font-bold text-slate-700 text-xs">
 <span>Add & Manage Employees</span>
 <ChevronRight size={14} />
 </Link>
 <Link href="/leaves" className="flex items-center justify-between p-3 rounded-xl bg-slate-50 hover:bg-slate-100 font-bold text-slate-700 text-xs">
