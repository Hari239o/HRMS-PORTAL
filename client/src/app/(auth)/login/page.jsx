...
const Login = () => {
 ...
 type="text" 
 required 
 className="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#ff5a1f] focus:border-[#ff5a1f] text-slate-900 text-lg"
 value={email}
 ...
 type="submit" 
 disabled={loading}
 className="w-full bg-[#ff5a1f] hover:bg-[#e64a10] text-white py-3.5 mt-2 rounded-xl font-bold shadow-md hover:shadow-lg active:scale-[0.98]"
 >
 {loading ? (
 ...
 className="w-full py-3.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold "
 >
 Acknowledge & Return
 </button>
 </div>
